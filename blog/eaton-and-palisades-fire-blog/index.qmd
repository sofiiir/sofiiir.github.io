...
We join the fire perimeter data with the EJI data leaving the default `intersects` parameter. The EJI data is cropped to areas where the EJI rater intersects with the fire perimeters. We'll save these as their own objects to use for mapping below. 
...
# Add overall title
fig.suptitle('Fire Areas Comparison - Percentile rank: probability of contracting cancer over a lifetime due to air toxins')
