...
Finally, let's plot the fire perimeters mapping the percentile rank of the probability of contracting cancer over the course of a lifetime, assuming continuous exposure to toxic air particulate matters including exposure to PM2.5, ozone, and diesel particulate matter.
```{python}
...
# Add overall title
fig.suptitle('Percentile rank of the probability of contracting cancer over the course of a lifetime, assuming continuous exposure - Fire Areas Comparison')

# Add shared colorbar at the bottom
sm = plt.cm.ScalarMappable( norm=plt.Normalize(vmin=vmin, vmax=vmax))
cbar_ax = fig.add_axes([0.25, 0.08, 0.5, 0.02])  # [left, bottom, width, height]
cbar = fig.colorbar(sm, cax=cbar_ax, orientation='horizontal')
cbar.set_label('Percentile rank of the probability of contracting cancer over the course of a lifetime')
