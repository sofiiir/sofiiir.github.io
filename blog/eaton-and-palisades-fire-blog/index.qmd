...
Again all of the CRS must match to accurately map the intended regions.
...
These individual clipped data can be plot on their own to view what was completed in the last clipping
...
# plot the clipped Palisades data 
...
These perimeters can also be plot with a basemap to better provide context of where the fires took place.
